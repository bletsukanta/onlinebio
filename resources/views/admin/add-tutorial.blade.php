...
@section('page_heading','Add Tutorial')
@section('section')
    ...
    {{Form::open (array ('url' => url('backend/postTutorial'),'name'=>'frmContent','id'=>'frmContent','onSubmit'=>'return validateTutorials()'))}}           
    
        <div class="col-lg-10">
            <div class="form-group">
                <label>Topic</label>
                {{Form::text('topic','', array ('placeholder'=>'Topic','class'=>"form-control",'id'=>'topic'))}}
            </div>
            <div class="form-group">
                <label>Content</label>
                {{Form::textarea('content','', array ('class'=>"ckeditor",'id'=>'content'))}}
            </div>
        </div>
        <div class="col-lg-10" align="center">
