...
@section('section')
    ...
    {{Form::open (array ('url' => url('backend/postFaq'),'name'=>'frmContent','id'=>'frmContent','onSubmit'=>'return validateFAQ()'))}}           
    
        <div class="col-lg-10">
            <div class="form-group">
                <label>Question</label>
                {{Form::text('question','', array ('placeholder'=>'Question','class'=>"form-control",'id'=>'question'))}}
            </div>
            <div class="form-group">
                <label>Answer</label>
                {{Form::textarea('answer','', array ('class'=>"ckeditor",'id'=>'answer'))}}
            </div>
        </div>
        <div class="col-lg-10" align="center">
